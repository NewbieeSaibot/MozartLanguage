...
_lr_productions = [
  ...
  ('builtin_functions -> PREDEFINED_IDENTIFIER ( params_list )','builtin_functions',4,'p_builtin_functions','mozart_parser.py',244),
  ('params_list -> expression','params_list',1,'p_params_list','mozart_parser.py',249),
  ('params_list -> params_list COMMA expression','params_list',3,'p_params_list','mozart_parser.py',250),
  ('arithmetic_expression -> IDENTIFIER','arithmetic_expression',1,'p_arithmetic_expression_identifier','mozart_parser.py',259),
  ('arithmetic_expression -> arithmetic_literal','arithmetic_expression',1,'p_arithmetic_expression_arithmetic_literal','mozart_parser.py',264),
  ('arithmetic_expression -> ( arithmetic_expression )','arithmetic_expression',3,'p_arithmetic_expression_in_brackets','mozart_parser.py',269),
  ('arithmetic_expression -> arithmetic_expression arithmetic_operator arithmetic_expression','arithmetic_expression',3,'p_arithmetic_expression_operation','mozart_parser.py',274),
  ('logic_expression -> BOOLEAN','logic_expression',1,'p_logic_expression_boolean','mozart_parser.py',279),
  ('logic_expression -> IDENTIFIER','logic_expression',1,'p_logic_expression_identifier','mozart_parser.py',284),
  ('logic_expression -> ( logic_expression )','logic_expression',3,'p_logic_expression_in_brackets','mozart_parser.py',289),
  ('logic_expression -> ( arithmetic_expression comparative_operator arithmetic_expression )','logic_expression',5,'p_logic_expression_ae_co_ae','mozart_parser.py',294),
  ('logic_expression -> logic_expression binary_logic_operator logic_expression','logic_expression',3,'p_logic_expression_le_lo_le','mozart_parser.py',299),
  ('logic_expression -> unary_logic_operator logic_expression','logic_expression',2,'p_logic_expression_uo_le','mozart_parser.py',304),
  ('arithmetic_literal -> REAL','arithmetic_literal',1,'p_arithmetic_literal_real','mozart_parser.py',309),
  ('arithmetic_literal -> INTEGER','arithmetic_literal',1,'p_arithmetic_literal_integer','mozart_parser.py',314),
]
